      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-[#25F4EE]/50 transition-all space-y-2.5">
            ...
            <h4 className="text-sm font-bold text-white">Avatar 3D &amp; Meshy AI</h4>
            <p className="text-xs text-zinc-400 leading-relaxed">
              Beranda interaktif dengan model 360° Sophia dan dukungan upload file model 3D GLB buatan Meshy AI.
            </p>
          </div>
